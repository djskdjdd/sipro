 ...
 *    pembatalan/refund berjurnal belum ada, jadi layar ini tidak berpura-pura menghitungnya.
 */
  ...
  const gap = (
    <div data-testid={CRMC.planGap}
      ...
      <p className="mt-1">
        ...
        nyata dari Keuangan. Yang <b>belum</b> dibangun: <b>toleransi keterlambatan</b> dan
        <b> mesin pembatalan/refund berjurnal</b> (usulan pembatalan otomatis beserta hitungan
        potongan). Sampai itu ada, keputusan pembatalan diambil manusia di menu Keuangan.
      </p>
    </div>
  );
